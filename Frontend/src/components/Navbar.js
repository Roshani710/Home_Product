              ...
              >
                <ul className="navbar-nav">
                  <li className="nav-item">
                    <Link className="nav-link" type="text" to="/homepage">
                      Home
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" type="text" to="/about">
                      About
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" type="text" to="/viewproduct">
                      Product
                    </Link>
                  </li>
                </ul>
              ...
              <div class="button-group-area mt-40">
                {localStorage.getItem("token") ? (
                  <form classname="d-flex">
                    <Link to="/cart" class="genric-btn primary radius">
                    Cart <span>{count}</span>
                    </Link>
                    <Link
                      to={"/orderhistory/" + user_id}

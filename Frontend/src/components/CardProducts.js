...
{/* <div class="col-lg-4 col-md-6 col-12 single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src='logo512.png' alt="" /></a>
						</div>
						<h3>{product_name}</h3>
						<p class="product-price"> {product_price} $ </p>
						<Link to="cart.js" class="cart-btn" value='Add to Cart'/><i class="fas fa-shopping-cart"></i> 
					</div> */}
        </>
    )
}
